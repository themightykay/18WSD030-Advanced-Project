...
# Generated: Tue Jul 17 07:19:05 2007
##################################################
...
class tutorial_two_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        ##################################################
        self.freq = freq = 2000
        self.sample_rate = sample_rate = 5*freq
        ...
        self._sample_rate_range = Range(0.5*freq, 20*freq, 200, 5*freq, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(10000, analog.GR_SIN_WAVE, freq, 1, 0)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.set_sample_rate(5*self.freq)
