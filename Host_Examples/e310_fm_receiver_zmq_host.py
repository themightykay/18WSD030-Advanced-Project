...
# Generated: Thu Dec  6 17:29:49 2018
##################################################
...
class e310_fm_receiver_zmq_host(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(80e6, 500e6, 10e3, 430e6, 200)
        ...
        self.connect((self.zeromq_pull_source_0_0_0, 0), (self.qtgui_sink_x_0, 0))
    ...
    def set_freq(self, freq):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.freq, 1e6)
