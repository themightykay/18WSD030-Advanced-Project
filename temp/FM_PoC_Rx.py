...
# Generated: Fri Dec  7 13:28:51 2018
##################################################
...
class FM_PoC_Rx(gr.top_block):
    ...
    def __init__(self, freq=430e6, rx_gain=50):
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0_0_0_0 = zeromq.push_sink(gr.sizeof_gr_complex, 1, 'tcp://*:9995', 100, False, -1)
        self.zeromq_push_sink_0_0_0 = zeromq.push_sink(gr.sizeof_gr_complex, 1, 'tcp://*:9999', 100, False, -1)
        self.zeromq_push_sink_0_0 = zeromq.push_sink(gr.sizeof_float, 1, 'tcp://*:9993', 100, False, -1)
